...
help:
	...
	@echo 'install        - developer install of AXIOM into virtualenv'
...
search.checker: install
	$(Q)./manage pyenv.cmd axiom-checker -v

search.checker.%: install
	$(Q)./manage pyenv.cmd axiom-checker -v "$(subst _, ,$(patsubst search.checker.%,%,$@))"
